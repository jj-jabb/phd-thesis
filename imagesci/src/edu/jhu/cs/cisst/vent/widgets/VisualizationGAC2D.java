...
import edu.jhu.cs.cisst.vent.renderer.processing.ActiveContourRenderer2D;
 ...
 */
public class VisualizationGAC2D extends VisualizationImage2D implements
	 ...
	 */
	public VisualizationGAC2D(int width, int height, WEGAC2D simulator) {
	...
	public ParamCollection create() {
		...
		levelsetRenderer = new ActiveContourRenderer2D(this, simulator);
