...
import edu.jhu.ece.iacl.jist.pipeline.view.input.ParamTextInputView;
import edu.jhu.ece.iacl.jist.pipeline.view.output.ParamOutputView;

// TODO: Auto-generated Javadoc
/**
 * String Parameter Factory.
 * 
 * @author Blake Lucas
 */
public class ParamStringFactory extends ParamFactory {

	/** The param. */
	protected ParamString param;

	/**
	 * Instantiates a new param string factory.
	 * 
	 * @param param
	 *            the param
	 */
	public ParamStringFactory(ParamString param) {
		super();
		this.param = param;
	}
	...
	public ParamInputView getInputView() {
		if (inputView == null) {
			inputView = new ParamTextInputView(param);
		}
		return inputView;
	}
