...
/**
 * Long Parameter Factory.
 * 
 * @author Blake Lucas
 */
public class ParamLongFactory extends ParamFactory {

	/** The param. */
	protected ParamLong param;

	/**
	 * Instantiates a new param long factory.
	 * 
	 * @param param
	 *            the param
	 */
	public ParamLongFactory(ParamLong param) {
		this.param = param;
	}
