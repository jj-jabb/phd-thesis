 ...
 */
public class VisualizationMUSCLE3D extends
		VisualizationSpringlsActiveContour3D {

	/** The springls raycast render. */
	protected MUSCLERenderer3D springlsRaycastRender;
	 ...
	 *            the active contour
	 */
	public VisualizationMUSCLE3D(int width, int height,
			MuscleActiveContour3D activeContour) {
	...
	public ParamCollection create() {
		...
		renderers.add(springlsRaycastRender = (MUSCLERenderer3D) activeContour
	...
	@Override
	public void draw() {
		if (captureParam.getValue() || running || requestScreenShot) {
