...
import edu.jhu.ece.iacl.jist.pipeline.view.input.ParamHiddenInputView;
import edu.jhu.ece.iacl.jist.pipeline.view.input.ParamInputView;
import edu.jhu.ece.iacl.jist.pipeline.view.output.ParamOutputView;

// TODO: Auto-generated Javadoc
/**
 * Hidden Parameter Factory.
 * 
 * @author Blake Lucas
 */
public class ParamHiddenFactory extends ParamFactory {

	/** The param. */
	protected ParamHidden param;

	/**
	 * Instantiates a new param hidden factory.
	 * 
	 * @param param
	 *            the param
	 */
	public ParamHiddenFactory(ParamHidden param) {
		this.param = param;
	}
	...
	public ParamInputView getInputView() {
		if (inputView == null) {
			inputView = new ParamHiddenInputView(param);
		}
		return inputView;
	}
